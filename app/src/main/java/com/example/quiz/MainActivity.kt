...
class MainActivity : AppCompatActivity() {
    ...
    private val question = listOf(
        MOdelQuestion(
            "বঙ্গবন্ধু শেখ মুজিবুর রহমান কত তারিখে জন্মগ্রহন করেন?",
            "৯ জানুয়ারী ১৯৭২",
            "১৬ ডিসেম্বর ১৯৭২",
            "১৭ মার্চ ১৯২০ ",
            "১০ জানুয়ারি ১৯৭২",
        ...
        MOdelQuestion(
            "বঙ্গবন্ধু শেখ মুজিবুর রহমানের জন্মদিনে পালিত হয় কোন দিবস?",
            "নারী দিবস",
            "শিক্ষা দিবস",
            "শিশু দিবস",
            "স্বাস্হ",
        ...
        MOdelQuestion(
            "আন্তর্জাতিক শ্রমিক দিবস পালন করা হয় কত তারিখে?",
            "১ মে",
            "8 মে",
            "8 জুন",
            "জুলাই",
